...
<html lang="en">
    <head>
        ...
        <title>CWLT Trucking Services</title>
    ...
    <body>
        <nav class="navbar navbar-default navbar-fixed-top nav-cwlt">
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="myNavbar">
                    <div class="cwlt-navbar">
                        <div class="brand-logo">
                            <img src="assets/cwlt.jpg">
                            <div class="brand-name">
                                <div>CWLT</div>
                                <div>Trucking Services</div>
                            </div>
                        </div>
